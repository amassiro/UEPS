...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('/tmp/amassiro/WW1Mevents_TUNE_CMS_Z2Lep.root'),
    fileName = cms.untracked.string('/tmp/amassiro/WW1Mevents_TUNE_CMS_Z2Lep_all_events.root'),
...
process.generator = cms.EDFilter(
    ...
    PythiaParameters = cms.PSet(
        pythiaUESettings = cms.vstring(
            ...
            'MSTP(81)=21    ! multiple parton interactions 1 is Pythia default. 21 is on, 20 is off!', 
